...
const Navbar = ({
  ...
  const _procesarUrlNotif = useCallback(
    (url) => {
  ...
  const handleNavNotif = useCallback(
    (url) => {
  ...
  const handleNavNotifMovil = useCallback(
    (url) => {
      setPanelAbierto(false);
      setMenuAbierto(false);
      _procesarUrlNotif(url);
  ...
  //Toggle auto-logout
  const handleToggleAutoLogout = useCallback(
    async (e) => {
      e.stopPropagation();
      e.preventDefault();
  ...
  const handleCerrarSesionDesktop = useCallback(
    () => ejecutarCerrarSesion(),
    [ejecutarCerrarSesion],
  );
  const handleCerrarSesionMobile = useCallback(
          ...
          <ul className={`navMenu ${menuAbierto ? "activo" : ""}`}>
            ...
            {panelAbierto && esTactil && (
              <div className="pn-modal-movil" onClick={handleCerrarPanel}>
                <div
                  className="pn-modal-movil__contenido"
              ...
              <>
                ...
                >
                  <div className="nav-avatar-mini">
                    ...
                    <div
                      className="nav-avatar-iniciales"
                      style={{
                        display:
                          user.avatar &&
                          !user.avatar.includes("googleusercontent.com")
                ...
                >
                  {!esTactil ? (
                    ...
                    >
                      <button
                        className="btn-secundario al-btn-trigger"
                        onClick={handleCerrarSesionDesktop}
                      >
                        Cerrar Sesión
                      </button>
                      {dropdownAbierto && (
                        <div className="al-dropdown">
                          <button
                            className="al-dropdown__logout-btn"
                            onClick={handleCerrarSesionDesktop}
                          >
                            <IcoCerrarSesion />
                            Cerrar Sesión
                          ...
                          <div className="al-dropdown__row">
                            <div className="al-dropdown__label">
                              <span className="al-dropdown__label-title">
                                Cierre automático
                              </span>
                              <span className="al-dropdown__label-sub">
                                {autoLogout
                                  ? `Activo · ${user?.autoLogoutMinutes ?? 15} min sin actividad`
                                  : "Inactivo · cierre manual"}
                              </span>
                            </div>
                            <ToggleSwitch
                              enabled={autoLogout}
                    ...
                    <button
                      ...
                      onClick={handleCerrarSesionMobile}
                    >
                      Cerrar Sesión
                    </button>
                  )}
      ...
      {modalCerrarAbierto &&
        createPortal(
          <div
            ...
            onTouchStart={(e) => {
              if (e.target === e.currentTarget) setModalCerrarAbierto(false);
            }}
          >
            <div
              className="al-modal"
            ...
            >
              ...
              <div className="al-modal__toggle-row">
                <div className="al-modal__toggle-label">
                  <span className="al-modal__toggle-title">
              ...
              <div className="al-modal__actions">
                <button
                  className="al-modal__btn-cancelar"
                  onClick={() => setModalCerrarAbierto(false)}
                >
                  Cancelar
                </button>
                <button
                  className="al-modal__btn-confirmar"
