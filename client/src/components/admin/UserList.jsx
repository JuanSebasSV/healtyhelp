    ...
    <div className="ban-modal-overlay" onClick={onClose}>
      <div className="ban-modal msg-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="ban-modal-campo">
          <label>
            Asunto <span className="ban-opcional">(opcional)</span>
          </label>
          <input
            type="text"
            value={asunto}
  ...
  const handleConfirm = async () => {
    ...
    try {
      await onBan(
        ...
        motivo,
        tipo === "permanente" ? null : parseInt(dias),
      );
      onClose();
    } catch {
      setEnviando(false);
  ...
  return (
    <div className="ban-modal-overlay" onClick={onClose}>
      <div className="ban-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="ban-modal-campo">
          <label>
            Motivo <span className="ban-opcional">(opcional)</span>
          </label>
          <textarea
            value={motivo}
        ...
        {tipo === "dias" && (
          <div className="ban-modal-campo">
            ...
            <input
              ...
              value={dias}
              onChange={(e) =>
                setDias(Math.max(1, parseInt(e.target.value) || 1))
              }
        ...
        {tipo === "permanente" && (
          <p className="ban-aviso-permanente">
            ⚠️ El usuario no podrá iniciar sesión indefinidamente hasta que un
            administrador lo desbanee manualmente.
          </p>
        )}
            ...
            >
              ...
              <div className="ucard-mid">
                {canEdit ? (
                  ...
                  <span
                    className={`badge ${user.isSuperAdmin ? "super-admin" : user.role === "admin" ? "admin" : "user"}`}
                  >
                    {user.isSuperAdmin
                      ? "⭐ Super Admin"
                      : user.role === "admin"
