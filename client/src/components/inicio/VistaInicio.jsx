...
const CATEGORIAS = [
  {
    ...
    nombre: "Todas",
    icono:
      '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>',
  },
  {
    id: "desayuno",
    nombre: "Desayuno",
    icono:
      '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>',
  },
  {
    id: "almuerzo",
    nombre: "Almuerzo",
    icono:
      '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v2"/><path d="M14.837 16.385a6 6 0 1 1-7.223-7.222c.624-.147.97.66.715 1.248a4 4 0 0 0 5.26 5.259c.589-.255 1.396.09 1.248.715"/><path d="M16 12a4 4 0 0 0-4-4"/><path d="m19 5-1.256 1.256"/><path d="M20 12h2"/></svg>',
  },
  {
    id: "cena",
    nombre: "Cena",
    icono:
      '<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401"/></svg>',
  },
  {
    id: "postres-snacks",
    nombre: "Postres & Snacks",
    icono:
      '<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#e26e6e" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M16 13H3"/><path d="M16 17H3"/><path d="m7.2 7.9-3.388 2.5A2 2 0 0 0 3 12.01V20a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-8.654c0-2-2.44-6.026-6.44-8.026a1 1 0 0 0-1.082.057L10.4 5.6"/><circle cx="9" cy="7" r="2"/></svg>',
  },
];
...
const CONDICIONES = [
  {
    ...
    nombre: "Diabetes",
    icono:
      '<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="m18 2 4 4"/><path d="m17 7 3-3"/><path d="M19 9 8.7 19.3c-1 1-2.5 1-3.4 0l-.6-.6c-1-1-1-2.5 0-3.4L15 5"/><path d="m9 11 4 4"/><path d="m5 19-3 3"/><path d="m14 4 6 6"/></svg>',
  },
  {
    id: "hipertension",
    nombre: "Hipertensión",
  ...
  },
  {
    ...
    icono:
      '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 4V2"/><path d="M5 10v4a7.004 7.004 0 0 0 5.277 6.787c.412.104.802.292 1.102.592L12 22l.621-.621c.3-.3.69-.488 1.102-.592a7.01 7.01 0 0 0 4.125-2.939"/><path d="M19 10v3.343"/><path d="M12 12c-1.349-.573-1.905-1.005-2.5-2-.546.902-1.048 1.353-2.5 2-1.018-.644-1.46-1.08-2-2-1.028.71-1.69.918-3 1 1.081-1.048 1.757-2.03 2-3 .194-.776.84-1.551 1.79-2.21m11.654 5.997c.887-.457 1.28-.891 1.556-1.787 1.032.916 1.683 1.157 3 1-1.297-1.036-1.758-2.03-2-3-.5-2-4-4-8-4-.74 0-1.461.068-2.15.192"/><line x1="2" x2="22" y1="2" y2="22"/></svg>',
  },
  {
    id: "sin-mariscos",
    nombre: "Sin Mariscos",
    icono:
      '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 12.47v.03m0-.5v.47m-.475 5.056A6.744 6.744 0 0 1 15 18c-3.56 0-7.56-2.53-8.5-6 .348-1.28 1.114-2.433 2.121-3.38m3.444-2.088A8.802 8.802 0 0 1 15 6c3.56 0 6.06 2.54 7 6-.309 1.14-.786 2.177-1.413 3.058"/><path d="M7 10.67C7 8 5.58 5.97 2.73 5.5c-1 1.5-1 5 .23 6.5-1.24 1.5-1.24 5-.23 6.5C5.58 18.03 7 16 7 13.33m7.48-4.372A9.77 9.77 0 0 1 16 6.07m0 11.86a9.77 9.77 0 0 1-1.728-3.618"/><path d="m16.01 17.93-.23 1.4A2 2 0 0 1 13.8 21H9.5a5.96 5.96 0 0 0 1.49-3.98M8.53 3h5.27a2 2 0 0 1 1.98 1.67l.23 1.4M2 2l20 20"/></svg>',
  },
  {
    id: "bajo-grasa",
    nombre: "Bajo en Grasas",
    icono:
      '<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#ffffff"><path d="m865-210-73-73 40-397H450l-10-80h200v-160h80v160h200l-55 550ZM625-449ZM819-28 27-820l57-57L876-85l-57 57ZM40-200v-80h600v80H40ZM80-40q-17 0-28.5-11.5T40-80v-40h600v40q0 17-11.5 28.5T600-40H80Zm282-559v80q-5 0-11-.5t-11-.5q-59 0-111.5 20T147-440h374l80 80H40q0-121 93.5-180.5T340-600q5 0 11 .5t11 .5Zm-22 159Z"/></svg>',
  },
  {
    id: "sin-azucar",
    nombre: "Sin Azúcar",
...
const VistaInicio = ({
  ...
  const {
    ...
    limpiarTodo,
    listo,
    filtroTiempo, // ← NUEVO: viene del hook, persiste en localStorage
    cambiarFiltroTiempo, // ← NUEVO
    limpiarTiempo, // ← NUEVO
  ...
  // ← ELIMINADO: const [filtroTiempo, setFiltroTiempo] = useState(null);
  //   Ahora viene del hook de arriba.
  ...
  // ← ACTUALIZADO: ahora delega al hook para persistir en localStorage
    ...
    <div className="vistaInicio">
      ...
      <div className="filtros-bloque">
        ...
        <div className="filtros-top-row">
          ...
          >
            ...
            {totalCondicionesActivas > 0 && (
              <span className="filtroModalBadge">
                {totalCondicionesActivas}
              </span>
            )}
          </button>
        </div>
        ...
        <div className="filtros-segunda-fila">
          <div className="cats-scroll-outer">
            <div className="cats-scroll-inner">
              {CATEGORIAS.map((cat) => {
                const esActivo =
                  cat.id === "todas" ? categoria === "" : categoria === cat.id;
                return (
                  <button
                    key={cat.id}
          ...
          <div className="tiempo-wrapper">
            ...
            {filtroTiempo && (
              <button className="tiempo-seg__limpiar" onClick={limpiarTiempo}>
                {" "}
                {/* ← ACTUALIZADO */}
                <svg
                  width="11"
        ...
        {busqueda && (
          <span className="buscador-conteo">
            {recetasFiltradas.length} resultado
            {recetasFiltradas.length !== 1 ? "s" : ""} para &ldquo;{busqueda}
            &rdquo;
          </span>
        )}
      </div>
      ...
      {filtroAbierto && (
        <div
          ...
          onClick={(e) => {
            if (e.target === e.currentTarget) setFiltroAbierto(false);
          }}
        >
          <div className="filtroModal">
            ...
            <div className="filtroModalBody">
              <div className="filtroInfo">
                <p>
                  Selecciona todas las condiciones que se apliquen a ti. Solo
                  verás recetas que cumplan con todas tus necesidades.
                </p>
                {!listo && (
                  <p className="filtroInfo-cargando">Cargando tu perfil...</p>
                )}
                {totalCondicionesActivas > 0 && (
              ...
              <div className="filtroGrid">
                {CONDICIONES.map((c) => (
                  <button
                    ...
                    onClick={() => handleToggleFiltro(c.id)}
                  >
                    <span
                      className="filtroIcono"
                      dangerouslySetInnerHTML={{ __html: c.icono }}
                    />
                    <span className="filtroNombre">{c.nombre}</span>
                    {filtros.includes(c.id) && (
            ...
            {recetasFiltradas.map((receta) => {
              ...
              return (
                <TarjetaReceta
                  ...
                  resenaIdDestacada={
                    esPendiente
                      ? (recetaPendiente?.resenaId ?? null)
                      : undefined
                  }
                  respuestaIdDestacada={
                    esPendiente
                      ? (recetaPendiente?.respuestaId ?? null)
                      : undefined
                  }
                  onPendienteResuelta={
